-- ═══════════════════════════════════════════════════════════════
-- Migration 321: Tabla pages (recursos/páginas) como fuente de verdad
--
-- Crea un catálogo de páginas con código único. Cada fila representa un
-- recurso al que se le puede dar/quitar permiso por perfil.
--
-- El campo `code` es el valor que se usa en `user_type_permissions.section`
-- y en `nav-data.ts` -> `NavLink.section`.
--
-- SIN borrar datos. Seeding idempotente con ON CONFLICT.
-- ═══════════════════════════════════════════════════════════════
