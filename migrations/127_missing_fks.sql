...
ALTER TABLE public.claim_actions DROP CONSTRAINT IF EXISTS claim_actions_issuer_id_fkey;
...
ALTER TABLE public.claim_actions DROP CONSTRAINT IF EXISTS claim_actions_reviewer_id_fkey;
ALTER TABLE public.claim_actions
  ADD CONSTRAINT claim_actions_reviewer_id_fkey
  FOREIGN KEY (reviewer_id) REFERENCES public.profiles(id) ON DELETE SET NULL;

ALTER TABLE public.claim_actions DROP CONSTRAINT IF EXISTS claim_actions_approver_id_fkey;
ALTER TABLE public.claim_actions
  ADD CONSTRAINT claim_actions_approver_id_fkey
  FOREIGN KEY (approver_id) REFERENCES public.profiles(id) ON DELETE SET NULL;

ALTER TABLE public.claim_actions DROP CONSTRAINT IF EXISTS claim_actions_dispatcher_id_fkey;
ALTER TABLE public.claim_actions
...
ALTER TABLE public.action_features DROP CONSTRAINT IF EXISTS action_features_screen_id_fkey;
