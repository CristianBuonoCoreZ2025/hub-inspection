...
export const CLAIM_FIELDS: ClaimField[] = [
  ...
  },
  {
    ...
    label: "Dirección",
    required: true,
    description: "Dirección del siniestro o del asegurado",
    synonyms: ["direccion", "dirección", "address", "calle", "ubicacion", "ubicación", "domicilio", "lugar"],
  },
  {
    key: "city",
    label: "Ciudad",
    required: true,
    description: "Ciudad o comuna del siniestro",
    synonyms: ["ciudad", "city", "comuna", "localidad", "poblacion"],
  },
  {
    key: "claimDate",
  ...
  },
  {
    ...
    label: "Apellido",
    required: false,
    synonyms: ["apellido", "apellidos", "last name", "last_name", "lastname", "apellido asegurado"],
  },
  {
    key: "rut",
    label: "RUT",
    required: false,
    synonyms: ["rut", "rut asegurado", "rut_asegurado", "documento", "identificacion"],
  },
  {
    key: "insuredEmail",
    label: "Email Asegurado",
    required: false,
    synonyms: ["email asegurado", "email", "correo", "insured email", "insured_email", "insuredemail", "e-mail", "mail"],
  },
  {
    key: "insuredPhone",
    label: "Teléfono Asegurado",
    required: false,
    synonyms: ["teléfono", "telefono", "fono", "insured phone", "insured_phone", "insuredphone", "telefono asegurado", "teléfono asegurado", "telefono fijo"],
  },
  {
    key: "cellPhone",
    label: "Celular",
    required: false,
    synonyms: ["celular", "móvil", "movil", "cell phone", "cell_phone", "cellphone", "mobile", "cel"],
  },
  {
    key: "commune",
    label: "Comuna",
    required: false,
    synonyms: ["comuna", "commune", "comuna siniestro", "comuna_asegurado"],
  },
  {
    key: "region",
    label: "Región",
    required: false,
    synonyms: ["región", "region", "state", "provincia", "estado"],
  },
  {
    key: "country",
    label: "País",
    required: false,
    synonyms: ["país", "pais", "country", "nacion", "nación"],
  },
  {
    key: "contactName",
