...
export const CLAIM_FIELDS: ClaimField[] = [
  ...
  },
  {
    ...
    synonyms: ["nombre asegurado", "nombre", "asegurado", "insured name", "insured_name", "insuredname", "nombre del asegurado", "titular", "cliente", "nombre contratante", "contratante"],
  },
  {
    key: "address",
    label: "Dirección Contratante",
    required: true,
    description: "Dirección del contratante/asegurado",
    synonyms: ["direccion contratante", "dirección contratante", "direccion asegurado", "dirección asegurado", "domicilio contratante", "domicilio asegurado", "address", "calle", "ubicacion", "ubicación", "domicilio", "lugar"],
  },
  {
    key: "city",
    label: "Ciudad Contratante",
    required: true,
    description: "Ciudad del contratante/asegurado",
    synonyms: ["ciudad contratante", "ciudad asegurado", "ciudad", "city", "localidad", "poblacion"],
  },
  {
    key: "claimDate",
  ...
  },
  {
    ...
    required: false,
    synonyms: ["apellido contratante", "apellido asegurado", "apellido", "apellidos", "last name", "last_name", "lastname", "apellido del contratante"],
  },
  {
    key: "rut",
    label: "RUT Contratante",
    required: false,
    synonyms: ["rut contratante", "rut asegurado", "rut", "rut_asegurado", "documento", "identificacion", "rut del contratante"],
  },
  {
    key: "insuredEmail",
    label: "E-mail Contratante",
    required: false,
    synonyms: ["e-mail contratante", "email contratante", "correo contratante", "email asegurado", "email", "correo", "insured email", "insured_email", "insuredemail", "e-mail", "mail", "mail contratante"],
  },
  {
    key: "insuredPhone",
    label: "Teléfono Contratante",
    required: false,
    synonyms: ["telefono contratante", "teléfono contratante", "fono contratante", "teléfono", "telefono", "fono", "insured phone", "insured_phone", "insuredphone", "telefono asegurado", "teléfono asegurado", "telefono fijo"],
  },
  {
    key: "cellPhone",
  ...
  },
  {
    ...
    required: false,
    synonyms: ["comuna contratante", "comuna asegurado", "comuna", "commune"],
  },
  {
    key: "region",
    label: "Región Contratante",
    required: false,
    synonyms: ["region contratante", "región contratante", "region asegurado", "región", "region", "state", "provincia", "estado"],
  },
  {
    key: "country",
    label: "País Contratante",
    required: false,
    synonyms: ["pais contratante", "país contratante", "pais asegurado", "país", "pais", "country", "nacion", "nación"],
  },
