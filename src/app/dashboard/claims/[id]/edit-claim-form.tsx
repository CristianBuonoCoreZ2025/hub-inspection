...
function EditInput({
 ...
 <Input className="app-input h-7" {...props} />
 </div>
 );
}
...
function EditRutInput({
 ...
 <FieldLabel label={label} required={required} />
 <Input
 className="app-input h-7 uppercase"
 value={value}
 onChange={onChange}
 onBlur={(e) => {
...
export default function EditClaimForm({ claim, participants, catalogs, onCancel, onSaved, initialTab = "siniestro" }: EditClaimFormProps) {
 ...
 // Asegurado
 insuredPersonType: insured?.person_type === "legal" ? "legal" : "natural",
 insuredFirstName: insured?.person_type === "legal" ? "" : (insured?.first_name || ""),
 insuredLastName: insured?.person_type === "legal" ? "" : (insured?.last_name || ""),
 insuredBusinessName: insured?.person_type === "legal" ? (insured?.full_name || "") : "",
 ...
 // Contractor
 contractorPersonType: contractor?.person_type === "legal" ? "legal" : "natural",
 contractorFirstName: contractor?.person_type === "legal" ? "" : (contractor?.first_name || ""),
 contractorLastName: contractor?.person_type === "legal" ? "" : (contractor?.last_name || ""),
 contractorBusinessName: contractor?.person_type === "legal" ? (contractor?.full_name || "") : "",
 ...
 // Beneficiary
 beneficiaryPersonType: beneficiary?.person_type === "legal" ? "legal" : "natural",
 beneficiaryFirstName: beneficiary?.person_type === "legal" ? "" : (beneficiary?.first_name || ""),
 beneficiaryLastName: beneficiary?.person_type === "legal" ? "" : (beneficiary?.last_name || ""),
 beneficiaryBusinessName: beneficiary?.person_type === "legal" ? (beneficiary?.full_name || "") : "",
 ...
 // Persona de Contacto
 contactPersonType: contact?.person_type === "legal" ? "legal" : "natural",
 contactFirstName: contact?.person_type === "legal" ? "" : (contact?.first_name || ""),
 contactLastName: contact?.person_type === "legal" ? "" : (contact?.last_name || ""),
 contactBusinessName: contact?.person_type === "legal" ? (contact?.full_name || "") : "",
 ...
 first_name: insuredIsLegal ? null : insuredName,
 ...
 first_name: contractorIsLegal ? null : contractorName,
 ...
 first_name: beneficiaryIsLegal ? null : beneficiaryName,
