  ...
  return (
    <div className="app-page">
      ...
      <div className="dash-section-header" style={{ marginTop: 0 }}>
        <div className={`flex h-11 w-11 items-center justify-center rounded-2xl bg-linear-to-br ${config.gradient} text-white shadow-lg shrink-0`}>
      ...
      {/* ── Buscador + Cards — Glass Panel ── */}
      <div className="glass-panel dash-col-12" style={{ marginTop: 16, ["--glass-glow" as string]: config.glow }}>
        <div className="glass-panel-header">
          <div className="glass-panel-title">
            <Search className="h-4 w-4 text-muted-foreground" />
            <span>Buscar en mis gestiones</span>
          </div>
        </div>
