...
import { Search, Pencil, Ban, Briefcase, Users } from "lucide-react";
...
export default function CorredoresPage() {
 ...
 <div className="flex h-8 w-8 items-center justify-center rounded-lg icn-sky text-white shadow-sm"><Briefcase className="h-4 w-4" /></div>
