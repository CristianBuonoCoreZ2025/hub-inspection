...
import { getClaimCauses, createClaimCause, updateClaimCause, deleteClaimCause } from "@/services/catalogs";
                  ...
                  <td>
                    <div className="flex items-center gap-1">
                      <Button variant="ghost" size="icon" className="btn-neutral btn-icon" onClick={() => {
                        ...
                        setFormData({ name: cause.name, description: cause.description || "" });
                        setOpen(true);
