...
async function main() {
  ...
  try {
    ...
    const sql = fs.readFileSync('migrations/215_drop_old_inspection_policies.sql', 'utf8');
    console.log('⏳ Aplicando migración 215...\n');
    await client.query(sql);
    console.log('✅ Migración 215 aplicada\n');
    ...
    console.error('\n❌ Error aplicando migración 215:', err.message || err);
    process.exit(1);
  } finally {
    await client.end();
  }
