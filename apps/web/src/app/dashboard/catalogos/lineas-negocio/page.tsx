    ...
    <div className="app-page">
      <div className="app-grid-header">
        <div className="app-grid-header-left">
          <div className="app-grid-icon icn-indigo">
            <Layers />
          </div>
        ...
        <DialogContent className="modal-md" showCloseButton={false}>
          <div className="modal-header">
            <DialogTitle className="modal-title flex items-center gap-2.5">
              <div className="flex h-8 w-8 items-center justify-center rounded-lg icn-sky text-white shadow-sm"><Tag className="h-4 w-4" /></div>
            ...
            <div className="modal-body modal-grid">
              <div className="modal-grid">
                ...
                <div className="modal-field">
                  ...
                  >
                    <SelectTrigger className="app-input"><SelectValue placeholder="Seleccionar tipo..." /></SelectTrigger>
                    <SelectContent>
                      <SelectItem value="__none">Sin selección</SelectItem>
