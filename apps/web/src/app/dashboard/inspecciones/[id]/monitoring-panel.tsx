            ...
            {alerts.map((alert, i) => (
              <Tooltip key={i}>
                <TooltipTrigger className="w-full">
                  <div
                    className={`flex items-center gap-1.5 px-2 py-1.5 rounded-md border truncate ${
                      alert.severity === "high"
                  ...
                  >
                    <AlertTriangle className={`h-3 w-3 shrink-0 ${alert.severity === "high" ? "text-rose-500" : "text-amber-500"}`} />
